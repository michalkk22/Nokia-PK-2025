...
QtCallMode::QtCallMode(QtPhoneNumberEdit &phoneNumberEdit,
...
void QtCallMode::connectSignals() {
  connect(&outgoingTextEdit, &QtSubmitTextEdit::submitted,
          [this]() { emit textEntered(); });
  connect(this, SIGNAL(appendTalkTextSignal(QString)), this,
          SLOT(appendTalkTextSlot(QString)));
  connect(this, SIGNAL(activateForDialModeSignal()), this,
          SLOT(activateForDialModeSlot()));
}
