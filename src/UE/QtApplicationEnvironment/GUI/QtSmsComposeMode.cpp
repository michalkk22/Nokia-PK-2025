...
QtSmsComposeMode::QtSmsComposeMode(QtPhoneNumberEdit &phoneNumberTextEdit,
...
void QtSmsComposeMode::connectSignals() {
  connect(this, SIGNAL(setSmsTextSignal(QString)), this,
          SLOT(setSmsTextSlot(QString)));
  connect(this, SIGNAL(clearSmsTextSignal()), this, SLOT(clearSmsTextSlot()));
  connect(this, SIGNAL(activateForViewingSmsSignal()), this,
          SLOT(activateForViewingSmsSlot()));
}
...
QString QtSmsComposeMode::getText() const { return smsTextEdit.toPlainText(); }

PhoneNumber QtSmsComposeMode::getPhoneNumber() const {
  return QtUeModeWidget::getPhoneNumber();
}

std::pair<common::PhoneNumber, std::string>
QtSmsComposeMode::getComposedSmsData() {
...
void QtSmsComposeMode::clearSmsText() { emit clearSmsTextSignal(); }

void QtSmsComposeMode::clearSmsTextSlot() { smsTextEdit.clear(); }
