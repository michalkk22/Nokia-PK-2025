...
namespace ue {
    ...
    void BaseState::handleDisconnected() { logger.logError("Uexpected: handleDisconnected"); }
    ...
    void BaseState::handleSmsSentResult(common::PhoneNumber to, bool success) { logger.logError("Unexpected: handleSmsSentResult for: ", to, ", Success: ", success); }

    void BaseState::handleSmsComposeResult(common::PhoneNumber recipient, const std::string &text) { logger.logError("Unexpected: handleSmsComposeResult for: ", recipient, ", text: ", text); }
