...
Logger::Logger(std::ostream &logfile)
  ...
  static_assert(DEBUG_LEVEL == 0,
                "In this constructor DEBUG is assumed to be 0");
  static_assert(INFO_LEVEL == 1, "In this constructor INFO is assumed to be 1");
  static_assert(ERROR_LEVEL == 2,
                "In this constructor ERROR is assumed to be 2");
}
...
void Logger::log(Level level, const std::string &message) {
  ...
  ostr << "#" << number << ",tid:" << thisThreadId << levelInfo.prefix << ":"
       << message;
